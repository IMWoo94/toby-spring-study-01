...
class UserServiceTest {
    ...
    public void setUp(){
        users = Arrays.asList(
                ...
                new User("erwins", "신승한", "p3", Level.SILVER, 60, MIN_RECCOMENT_FOR_BRONZE-1),
                new User("madnite1", "이상호", "p4", Level.SILVER, 60, MIN_RECCOMENT_FOR_BRONZE),
                new User("lee", "이상민", "lee", Level.BRONZE, MIN_LOGCOUNT_FOR_GOLD, 70),
